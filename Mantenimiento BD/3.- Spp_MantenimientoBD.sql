...
--
   ...
   Begin
      ...
      Begin Try
         ...
         Select @w_servidor, @PsDbName, 'Comprobación de la integridad lógica y física de la base de datos', @w_fechaInicio
...
--
-- Actualiza el tipo de recuperación a Simple.
--
...
--
-- Actualiza la Base de datos a Usuario único
--
...
--
      ...
      Begin Try
         Insert Into dbo.logMantenimientoBDTbl
         (servidor, baseDatos, actividad, fechaInicio)
         Select @w_servidor, @PsDbName, 'Compactación Base de Datos', @w_fechaInicio
...
--
-- Compactación de los Archivos Logs que tenga relacionado la Base de datos.
--
      ...
      Begin
         ...
         Begin Try
            Insert Into dbo.logMantenimientoBDTbl
            (servidor, baseDatos, actividad, fechaInicio)
            Select @w_servidor, @PsDbName, Concat('Compactación Archivo Log.: ', @w_dbFile), @w_fechaInicio
...
--
-- Actualiza el tipo de recuperación a Inicial.
--
...
Declare
   @w_valor          Varchar(1500) = 'Análiza, Valida y compacta la Base de Datos.',
