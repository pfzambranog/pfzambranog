...
Begin
   Execute dbo.Spp_notificaMantBaseDatos        @PnIdProceso    = @PnIdProceso,
...
Create Or Alter Procedure dbo.Spp_notificaMantBaseDatos
  (@PnIdProceso             Integer,
...
--
   ...
   Insert Into #tempAnalisisBD
   (basedatos, actividad, fechaProceso, error,
    mensajeError)
   Select basedatos, actividad, fechaTermino, error,
          mensajeError
...
--
   ...
   Set @w_sql = Concat('Select Top 10 basedatos "Base de Datos", actividad Actividad, ',
...
Declare
   @w_valor          Varchar(1500) = 'Procedimiento que notifica la Ejecución del Mantenimiento de la Base de Datos.',
   @w_procedimiento  Varchar( 100) = 'Spp_notificaMantBaseDatos'
