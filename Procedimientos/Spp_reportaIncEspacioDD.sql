...
--
   ...
   Select @w_html = Replace(@w_html,     '&saludos&',       Trim(@w_saludo)),
          @w_html = Replace(@w_html,     '&incidencia%',    Concat('<b>', @w_incidencia, '</b>')),
          @w_html = Replace(@w_html,     '&tabla&',         Concat('<b>', @w_tabla     , '</b>')),
          @w_html = Replace(@w_html,     '&idProceso%',     Concat('<b>', @w_idProceso , '</b>')),
          @w_html = Replace(@w_html,     '&server&',        Concat('<b>', @w_servidor  , '</b>')),
          @w_html = Replace(@w_html,     '&instancia&',     Concat('<b>', @w_instancia , '</b>')),
          @w_html = Replace(@w_html,     '&ambiente&',      Concat('<b>', @w_ambiente  , '</b>')),
          @w_html = Replace(@w_html,     '&ip&',            Concat('<b>', @w_ip        , '</b>')),
          @w_html = Replace(@w_html,     '&query%',         Concat('<b>', @w_totaldisponible, '</b>')),
          @w_html = Replace(@w_html,     'Query:',          'Espacio Disponible:      '),
          @w_html = Replace(@w_html,     '&objeto%',        Concat('<b>', @w_porcentajeLibre, '</b>')),
