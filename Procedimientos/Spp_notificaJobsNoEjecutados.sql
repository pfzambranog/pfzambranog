...
Create Or Alter Procedure dbo.Spp_notificaJobsNoEjecutados
  (@PnIdProceso             Integer,
...
--
   ...
   Insert Into #tempAnalisisJobs
   (secuencia,     servidor,      Job,    idPaso,
    nombrePaso,    fechaInicio,   error,  mensajeError)
   Select secuencia,     servidor,      Job,    idPaso,
          nombrePaso,    fechaInicio,   error,  mensajeError
   From   dbo.logAnalisisJobsTbl a
   Where  informado   = 1
...
--
   ...
   Set @w_sql = Concat('Select Top 10 servidor,      Job,  idPaso Paso,
                               nombrePaso Nombre,    Convert(Char(10), fechaInicio, 103) "Fecha Proceso", ',
...
Declare
   @w_valor          Varchar(1500) = 'Procedimiento que notifica las Tareas de Windows no Ejecutados.',
   @w_procedimiento  Varchar( 100) = 'Spp_notificaJobsNoEjecutados'
