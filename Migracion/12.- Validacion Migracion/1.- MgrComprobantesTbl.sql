...
--
-- Objetivo:    Script de Creación de Tabla de comprobación de comprobantes contables migrados
-- Fecha:       11/12/2024
...
If Exists ( Select Top 1 1
            ...
            Where  UId  = 1
            And    Type = 'U'
            And    Name = 'MgrComprobantesTbl')
   Begin
      Drop table dbo.MgrComprobantesTbl
   End
Go

Create Table dbo.MgrComprobantesTbl
(secuencia      Integer             Not Null Identity (1, 1),
 ...
 Constraint MgrComprobantesPk
 Primary Key (secuencia));

Create Unique Index MgrComprobantesIdx01 On MgrComprobantesTbl(fechaMov, referencia);
...
Execute sp_addextendedproperty    @name       = N'MS_Description',
                                  ...
                                  @level0name = N'dbo',
                                  @level1type = 'Table',
                                  @level1name = N'MgrComprobantesTbl'
Go
